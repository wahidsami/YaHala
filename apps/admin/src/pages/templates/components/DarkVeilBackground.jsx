...
function DarkVeilBackground(
    ...
    React.useEffect(() => {
        ...
        canvas.className = 'darkveil-background-canvas';
        ...
        return () => {
            ...
            if (gl.canvas.parentElement === parent) {
                parent.removeChild(gl.canvas);
            }
        };
    }, [hueShift, noiseIntensity, scanlineIntensity, speed, scanlineFrequency, warpAmount, resolutionScale]);

    return <div ref={containerRef} data-slot="dark-veil-background" className={mergeClassNames('darkveil-background-root', className)} {...props} />;
}

const ForwardedDarkVeilBackground = React.forwardRef(DarkVeilBackground);
ForwardedDarkVeilBackground.displayName = 'DarkVeilBackground';

export default ForwardedDarkVeilBackground;
