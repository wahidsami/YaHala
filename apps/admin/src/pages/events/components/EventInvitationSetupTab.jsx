            ...
            <div className="invitation-setup-grid">
                ...
                <section className="setup-card setup-card--wide">
                    ...
                    <div className="rsvp-gate-grid">
                        <div className="form-group"><label>{localize(i18n, 'Variant', 'النمط')}</label><select value={rsvpGate.style.variant} onChange={(e) => setGateField(['style', 'variant'], e.target.value)}><option value="minimal">{localize(i18n, 'Minimal', 'بسيط')}</option><option value="card">{localize(i18n, 'Card', 'بطاقة')}</option><option value="brand">{localize(i18n, 'Brand', 'هوية')}</option></select></div>
                        <div className="form-group"><label>{localize(i18n, 'Icon', 'الأيقونة')}</label><select value={rsvpGate.style.icon} onChange={(e) => setGateField(['style', 'icon'], e.target.value)}><option value="sparkles">{localize(i18n, 'Sparkles', 'بريق')}</option><option value="check">{localize(i18n, 'Check', 'علامة صح')}</option><option value="heart">{localize(i18n, 'Heart', 'قلب')}</option></select></div>
                        <div className="form-group"><label>{localize(i18n, 'Primary color', 'اللون الأساسي')}</label><input type="color" value={rsvpGate.style.primaryColor} onChange={(e) => setGateField(['style', 'primaryColor'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'Secondary color', 'اللون الثانوي')}</label><input type="color" value={rsvpGate.style.secondaryColor} onChange={(e) => setGateField(['style', 'secondaryColor'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Attendance title', 'عنوان الحضور (EN)')}</label><input type="text" value={rsvpGate.copy.en.attendanceTitle} onChange={(e) => setGateField(['copy', 'en', 'attendanceTitle'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Attendance title', 'عنوان الحضور (AR)')}</label><input type="text" value={rsvpGate.copy.ar.attendanceTitle} onChange={(e) => setGateField(['copy', 'ar', 'attendanceTitle'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Attendance message', 'رسالة الحضور (EN)')}</label><textarea rows={2} value={rsvpGate.copy.en.attendanceBody} onChange={(e) => setGateField(['copy', 'en', 'attendanceBody'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Attendance message', 'رسالة الحضور (AR)')}</label><textarea rows={2} value={rsvpGate.copy.ar.attendanceBody} onChange={(e) => setGateField(['copy', 'ar', 'attendanceBody'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Reason label', 'تسمية السبب (EN)')}</label><input type="text" value={rsvpGate.copy.en.reasonLabel} onChange={(e) => setGateField(['copy', 'en', 'reasonLabel'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Reason label', 'تسمية السبب (AR)')}</label><input type="text" value={rsvpGate.copy.ar.reasonLabel} onChange={(e) => setGateField(['copy', 'ar', 'reasonLabel'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Reason placeholder', 'نص السبب الافتراضي (EN)')}</label><input type="text" value={rsvpGate.copy.en.reasonPlaceholder} onChange={(e) => setGateField(['copy', 'en', 'reasonPlaceholder'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Reason placeholder', 'نص السبب الافتراضي (AR)')}</label><input type="text" value={rsvpGate.copy.ar.reasonPlaceholder} onChange={(e) => setGateField(['copy', 'ar', 'reasonPlaceholder'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Positive title', 'عنوان التأكيد (EN)')}</label><input type="text" value={rsvpGate.copy.en.positiveTitle} onChange={(e) => setGateField(['copy', 'en', 'positiveTitle'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Positive title', 'عنوان التأكيد (AR)')}</label><input type="text" value={rsvpGate.copy.ar.positiveTitle} onChange={(e) => setGateField(['copy', 'ar', 'positiveTitle'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Positive message', 'رسالة التأكيد (EN)')}</label><textarea rows={2} value={rsvpGate.copy.en.positiveBody} onChange={(e) => setGateField(['copy', 'en', 'positiveBody'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Positive message', 'رسالة التأكيد (AR)')}</label><textarea rows={2} value={rsvpGate.copy.ar.positiveBody} onChange={(e) => setGateField(['copy', 'ar', 'positiveBody'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Positive button', 'زر التأكيد (EN)')}</label><input type="text" value={rsvpGate.copy.en.positiveButton} onChange={(e) => setGateField(['copy', 'en', 'positiveButton'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Positive button', 'زر التأكيد (AR)')}</label><input type="text" value={rsvpGate.copy.ar.positiveButton} onChange={(e) => setGateField(['copy', 'ar', 'positiveButton'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Negative title', 'عنوان الاعتذار (EN)')}</label><input type="text" value={rsvpGate.copy.en.negativeTitle} onChange={(e) => setGateField(['copy', 'en', 'negativeTitle'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Negative title', 'عنوان الاعتذار (AR)')}</label><input type="text" value={rsvpGate.copy.ar.negativeTitle} onChange={(e) => setGateField(['copy', 'ar', 'negativeTitle'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Negative message', 'رسالة الاعتذار (EN)')}</label><textarea rows={2} value={rsvpGate.copy.en.negativeBody} onChange={(e) => setGateField(['copy', 'en', 'negativeBody'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Negative message', 'رسالة الاعتذار (AR)')}</label><textarea rows={2} value={rsvpGate.copy.ar.negativeBody} onChange={(e) => setGateField(['copy', 'ar', 'negativeBody'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'EN Negative button', 'زر الاعتذار (EN)')}</label><input type="text" value={rsvpGate.copy.en.negativeButton} onChange={(e) => setGateField(['copy', 'en', 'negativeButton'], e.target.value)} /></div>
                        <div className="form-group"><label>{localize(i18n, 'AR Negative button', 'زر الاعتذار (AR)')}</label><input type="text" value={rsvpGate.copy.ar.negativeButton} onChange={(e) => setGateField(['copy', 'ar', 'negativeButton'], e.target.value)} /></div>
                    </div>
